...
echo "Testing Doctor creation without availability field...\n";
...
try {
    ...
    // Try to create the doctor without the availability field
    ...
    echo "SUCCESS: Doctor creation works without availability field!\n";
