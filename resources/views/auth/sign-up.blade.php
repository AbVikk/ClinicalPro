...
<meta charset="utf-8">
    ...
    <title>:: Oreo Hospital :: Sign Up</title>
    <!-- Favicon-->
        ...
        <div class="col-md-12 content-center">
            <div class="card-plain">
                ...
                <div class="content text-center">
                    <p>You will be redirected to the new registration process.</p>
                    <div class="mt-4">
                        <a href="{{ route('register.initial') }}" class="btn btn-primary btn-round btn-block">START REGISTRATION</a>
                    </div>
                </div>
                <div class="footer text-center">
                    <h5><a href="{{ route('login') }}" class="link">You already have a membership?</a></h5>
                </div>
            </div>
        </div>
    </div>
...
// Redirect to new registration process automatically
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(function() {
        window.location.href = "{{ route('register.initial') }}";
    }, 3000);
});
</script>
</body>
