...
<meta charset="utf-8">
    ...
    <title>:: Oreo Hospital :: Professional Details</title>
  <!-- Favicon -->
    ...
    <div class="container">
        <div class="col-md-12 content-center">
            <div class="card-plain">
                <form class="form" id="licenseForm">
                    @csrf
                    <div class="header">
                        ...
                        <span>Please provide your license and specialization</span>
                    </div>
                    <div class="content">
                        <!-- Hidden user ID -->
                        ...
                        <small class="form-text text-muted" style="color: #2CA8FF;">Enter your professional license number</small>
                        
                        <div class="input-group mt-3">
                            <input type="text" class="form-control" name="specialization" placeholder="Enter Specialization" required>
                            <span class="input-group-addon">
                                <i class="zmdi zmdi-graduation-cap"></i>
                            </span>
                        </div>
                        <small class="form-text text-muted" style="color: #2CA8FF;">Enter your medical specialization</small>
                        
                        <div id="licenseSuccess" class="alert alert-success" style="display: none;"></div>
                        <div id="licenseError" class="alert alert-danger" style="display: none;"></div>
                    </div>
                    <div class="footer text-center" id="submitButtonContainer">
                        <button type="submit" class="btn btn-primary btn-round btn-block waves-effect waves-light" id="submitBtn">SAVE DETAILS</button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('licenseForm').addEventListener('submit', function(e) {
        ...
        // Submit via AJAX
        fetch('{{ route('register.process.license') }}', {
            method: 'POST',
            body: formData,
            headers: {
        ...
        .then(data => {
            if (data.success) {
                ...
                showError(data.message || 'Failed to save details. Please try again.');
