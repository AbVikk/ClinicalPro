...
<meta charset="utf-8">
    ...
    <title>:: Oreo Hospital :: Logout</title>
    <!-- Favicon -->
            ...
            <div class="card-plain">
                <form class="form" method="POST">
                    ...
                    <div class="content">                                                
                        ...
                        <p class="text-center">Thank you for using our system. You can sign back in whenever you need access.</p>
                    </div>
                    <div class="footer text-center">
                        <a href="{{ route('login') }}" class="btn btn-primary btn-round btn-block">SIGN IN AGAIN</a>
                    </div>
                </form>
            </div>
        </div>
