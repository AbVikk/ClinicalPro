    ...
    <div class="container">        
        ...
        <div class="navbar-collapse">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-white btn-round" href="{{ route('register.initial') }}">REGISTER</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="card-plain">
                <form class="form" id="otpForm">
                    ...
                    <div class="header">
                        ...
                        <span>Enter the 4-digit code sent to {{ $email ?? 'your email' }}</span>
                    </div>
                    <div class="content">                                                
                    ...
                    <div class="footer text-center">
                        ...
                        <h5><a href="{{ route('register.initial') }}" class="link">Back to Registration</a></h5>
                    </div>
                </form>
            </div>
        </div>
    ...
    function startOtpCountdown(seconds) {
        ...
        const timer = setInterval(() => {
            ...
            if (remainingTime <= 0) {
                ...
                showError('OTP has expired. Please restart registration.');
            }
        }, 1000);
    }
});
