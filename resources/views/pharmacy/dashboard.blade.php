...
<meta name="description" content="Pharmacy Dashboard - AI-Powered Inventory Management">
    ...
    <div class="row">
        ...
        <div class="col-lg-7 col-md-7 col-sm-12 text-right">
            <ul class="breadcrumb float-md-right">
                <li class="breadcrumb-item"><a href="{{ Auth::user()->role === 'primary_pharmacist' ? route('primary_pharmacist.dashboard') : (Auth::user()->role === 'senior_pharmacist' ? route('senior_pharmacist.dashboard') : route('clinic_pharmacist.dashboard')) }}"><i class="zmdi zmdi-home"></i> Clinical Pro</a></li>
            ...
            <div class="card">
                <div class="header">
                    <h2>
                        ...
                        <small>Current stock levels for all items.</small>
                    </h2>
                </div>
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->batches->isNotEmpty() ? $item->batches->first()->created_at->format('M d, Y') : 'N/A' }}</td>
                                    <td><span class="badge badge-success">Active</span></td>
                                    <td>
                                        <a href="#" class="btn btn-sm btn-outline-primary">Edit</a>
                                        <a href="#" class="btn btn-sm btn-outline-info">Order</a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
