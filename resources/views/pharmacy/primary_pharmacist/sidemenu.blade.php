    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('primary_pharmacist.dashboard') }}"><img src="{{ asset('assets/images/logo.svg') }}" width="30" alt="Clinical Pro"><span class="m-l-10">Clinical Pro</span></a>
            </div>
        </li>
        <li><a href="javascript:void(0);" class="ls-toggle-btn" data-close="true"><i class="zmdi zmdi-swap"></i></a></li>
        <li class="d-none d-lg-inline-block"><a href="{{ route('primary_pharmacist.dashboard') }}" title="Dashboard"><i class="zmdi zmdi-home"></i></a></li>
        <li class="d-none d-lg-inline-block"><a href="{{ route('primary_pharmacist.inventory.predictions') }}" title="Inventory Predictions"><i class="zmdi zmdi-chart"></i></a></li>
        ...
        <div class="tab-pane stretchRight active" id="dashboard">
            <div class="menu">
                <ul class="list">
                    <li>
                        <div class="user-info">
                            <div class="image"><a href="{{ route('primary_pharmacist.dashboard') }}">
                                @if(auth()->user()->photo)
                    ...
                    <li class="{{ request()->routeIs('primary_pharmacist.dashboard') ? 'active' : '' }}">
                        <a href="{{ route('primary_pharmacist.dashboard') }}">
                            <i class="zmdi zmdi-home"></i><span>Dashboard</span>
                        </a>
                    </li>
                    
                    <li class="header">INVENTORY MANAGEMENT</li>
                    <li class="{{ request()->routeIs('primary_pharmacist.pharmacy.drugs.*') ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="zmdi zmdi-hospital"></i><span>Drug Catalog</span>
                        </a>
                        <ul class="ml-menu">
                            <li class="{{ request()->routeIs('primary_pharmacist.pharmacy.drugs.create.form') ? 'active' : '' }}">
                                <a href="{{ route('primary_pharmacist.pharmacy.drugs.create.form') }}">Add Drug</a>
                            </li>
                            <li class="{{ request()->routeIs('primary_pharmacist.pharmacy.drugs.all') ? 'active' : '' }}">
                                <a href="{{ route('primary_pharmacist.pharmacy.drugs.all') }}">View All Drugs</a>
                            </li>
                            <li class="{{ request()->routeIs('primary_pharmacist.pharmacy.categories.*') ? 'active' : '' }}">
                                <a href="{{ route('primary_pharmacist.pharmacy.categories.index') }}">Categories</a>
                            </li>
                            <li class="{{ request()->routeIs('primary_pharmacist.pharmacy.mg.*') ? 'active' : '' }}">
                                <a href="{{ route('primary_pharmacist.pharmacy.mg.index') }}">MG Values</a>
                            </li>
                        </ul>
                    </li>
                    <li class="{{ request()->routeIs('primary_pharmacist.pharmacy.stock.*') || request()->routeIs('primary_pharmacist.clinic.request-stock') ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="zmdi zmdi-truck"></i><span>Stock Management</span>
                        </a>
                        <ul class="ml-menu">
                            <li class="{{ request()->routeIs('primary_pharmacist.pharmacy.stock.receive') ? 'active' : '' }}">
                                <a href="{{ route('primary_pharmacist.pharmacy.stock.receive') }}">Receive Stock</a>
                            </li>
                            <li class="{{ request()->routeIs('primary_pharmacist.clinic.request-stock') ? 'active' : '' }}">
                                <a href="{{ route('primary_pharmacist.clinic.request-stock') }}">Request Stock</a>
                            </li>
                        </ul>
                    </li>
                    <li class="{{ request()->routeIs('primary_pharmacist.pharmacists.*') ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="zmdi zmdi-accounts"></i><span>Pharmacists</span>
                        </a>
                        <ul class="ml-menu">
                            <li class="{{ request()->routeIs('primary_pharmacist.pharmacists.index') ? 'active' : '' }}">
                                <a href="{{ route('primary_pharmacist.pharmacists.index') }}">All Pharmacists</a>
                            </li>
                        </ul>
                    </li>
                    
                    <li class="header">SALES</li>
                    <li class="{{ request()->routeIs('primary_pharmacist.sales.*') ? 'active' : '' }}">
                        <a href="{{ route('primary_pharmacist.sales.index') }}" target="_blank">
                            <i class="zmdi zmdi-shopping-cart"></i><span>POS Terminal</span>
                        </a>
                    </li>
                    <li class="{{ request()->routeIs('primary_pharmacist.sold-orders.*') ? 'active' : '' }}">
                        <a href="{{ route('primary_pharmacist.sold-orders.index') }}">
                            <i class="zmdi zmdi-money-box"></i><span>Sold Orders</span>
                        </a>
                    </li>
                    
                    <li class="header">PRESCRIPTIONS</li>
                    <li class="{{ request()->routeIs('primary_pharmacist.prescriptions.*') ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="zmdi zmdi-collection-item"></i><span>Prescriptions</span>
                        </a>
                        <ul class="ml-menu">
                            <li class="{{ request()->routeIs('primary_pharmacist.prescriptions.index') ? 'active' : '' }}">
                                <a href="{{ route('primary_pharmacist.prescriptions.index') }}">All Prescriptions</a>
                            </li>
                        </ul>
                    </li>
                    
                    <li class="header">INVITATIONS</li>
                    <li class="{{ request()->routeIs('primary_pharmacist.invitations.*') ? 'active' : '' }}">
                        <a href="{{ route('primary_pharmacist.invitations.create') }}">
                            <i class="zmdi zmdi-email"></i><span>Create Invite Link</span>
                        </a>
                    </li>
