...
<title>:: Clinical Pro :: Drug MG Values</title>
<!-- Favicon -->
    ...
    <div class="row">
        ...
        <div class="col-lg-7 col-md-7 col-sm-12 text-right">
            <ul class="breadcrumb float-md-right">
                ...
                <li class="breadcrumb-item"><a href="{{ route('primary_pharmacist.pharmacy.dashboard') }}">Pharmacy</a></li>
            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown">
                        <li>
                            <a href="{{ route('primary_pharmacist.pharmacy.mg.create') }}" class="btn btn-raised btn-primary btn-sm">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('primary_pharmacist.pharmacy.mg.edit', $mg) }}" class="btn btn-sm btn-warning">
                                            <i class="zmdi zmdi-edit"></i> Edit
                                        </a>
                                        <form action="{{ route('primary_pharmacist.pharmacy.mg.destroy', $mg) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
