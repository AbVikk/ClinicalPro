...
<title>:: Clinical Pro :: Add Drug</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12 text-right">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('primary_pharmacist.pharmacy.drugs.all') }}">Pharmacy</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form id="drugForm" action="{{ route('primary_pharmacist.pharmacy.drugs.create') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="tab-content" id="drugTabContent">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <a href="{{ route('primary_pharmacist.pharmacy.categories.index') }}" class="small">Manage categories</a>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <a href="{{ route('primary_pharmacist.pharmacy.mg.index') }}" class="small">Manage MG values</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="batch_number" name="batch_number_inventory" value="{{ old('batch_number_inventory') }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                ...
                                <div class="tab-pane fade" id="inventory" role="tabpanel">
                                    ...
                                    <div class="form-navigation">
                                        ...
                                        <a href="{{ route('primary_pharmacist.dashboard') }}" class="btn btn-raised btn-default">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </form>
...
<script src="{{ asset('assets/bundles/libscripts.bundle.js') }}"></script> <script src="{{ asset('assets/bundles/vendorscripts.bundle.js') }}"></script>
