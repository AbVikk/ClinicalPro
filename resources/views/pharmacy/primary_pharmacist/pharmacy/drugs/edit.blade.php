...
<title>:: Clinical Pro :: Edit Drug</title>
<!-- Favicon -->
    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <h2>
                    <a href="{{ route('primary_pharmacist.pharmacy.drugs.view', $drug->id) }}" class="btn btn-sm btn-primary">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="body">
                        ...
                        <form method="POST" action="{{ route('primary_pharmacist.pharmacy.drugs.update', $drug->id) }}" id="edit-drug-form">
                            @csrf
                            @method('PUT')
