...
<title>:: Clinical Pro :: Create Invitation</title>
<!-- Favicon -->
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-7 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('primary_pharmacist.invitations.create') }}">Invitations</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <ul class="header-dropdown">
                            <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more"></i> </a>
                                <ul class="dropdown-menu dropdown-menu-right slideUp">
                                    <li><a href="{{ route('primary_pharmacist.invitations.create') }}">Create Invitation</a></li>
                                </ul>
                            </li>
                            <li class="remove">
                    ...
                    <div class="body">
                        ...
                        <form method="POST" action="{{ route('primary_pharmacist.invitations.store') }}">
                            @csrf
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="role" class="form-control show-tick" required>
                                            ...
                                            <option value="senior_pharmacist" {{ old('role') == 'senior_pharmacist' ? 'selected' : '' }}>Senior Pharmacist</option>
                                            <option value="clinic_pharmacist" {{ old('role') == 'clinic_pharmacist' ? 'selected' : '' }}>Clinic Pharmacist</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <button type="submit" class="btn btn-primary btn-round">Generate Invitation</button>
                                    <a href="{{ route('primary_pharmacist.dashboard') }}" class="btn btn-default btn-round">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
