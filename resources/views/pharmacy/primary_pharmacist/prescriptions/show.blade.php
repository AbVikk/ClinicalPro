...
<meta name="description" content="Primary Pharmacist prescription details">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-between align-items-center">
                ...
                <ul class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('primary_pharmacist.prescriptions.index') }}">Prescriptions</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="row mb-3">
            <div class="col-12 text-right">
                <a href="{{ route('primary_pharmacist.prescriptions.index') }}" class="btn btn-secondary btn-round"><i class="zmdi zmdi-arrow-left"></i> Back</a>
                <button class="btn btn-primary btn-round" onclick="window.print()"><i class="zmdi zmdi-print"></i> Print Paper</button>
                
                @if(Route::has('primary_pharmacist.prescriptions.print'))
                <a href="{{ route('primary_pharmacist.prescriptions.print', $prescription->id) }}" class="btn btn-info btn-round"><i class="zmdi zmdi-download"></i> Download PDF</a>
                @endif
            </div>
        </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-10 offset-lg-1">
                ...
                <div class="card prescription-paper" id="printable-area">
                    ...
                    <div class="mt-4">
                        <h5><strong>Medications Prescribed</strong></h5>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <br><small class="text-muted">{{ $item->drug->strength_mg ?? '' }}</small>
                                        </td>
                                        <td>{{ $item->dosage ?? '-' }}</td>
                                        <td>{{ $item->type ?? '-' }}</td>
                                        <td>{{ $item->duration ?? '-' }}</td>
