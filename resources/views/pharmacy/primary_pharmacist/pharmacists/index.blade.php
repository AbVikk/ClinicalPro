                        ...
                        <ul class="nav nav-tabs padding-0">
                            <li class="nav-item">
                                <a class="nav-link {{ is_null($roleFilter) ? 'active' : '' }}" 
                                   href="{{ route('primary_pharmacist.pharmacists.index') }}" 
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ $roleFilter === 'senior_pharmacist' ? 'active' : '' }}" 
                                   href="{{ route('primary_pharmacist.pharmacists.index', ['role' => 'senior_pharmacist']) }}" 
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ $roleFilter === 'clinic_pharmacist' ? 'active' : '' }}" 
                                   href="{{ route('primary_pharmacist.pharmacists.index', ['role' => 'clinic_pharmacist']) }}" 
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tbody id="pharmacistTableBody">
                                            @include('pharmacy.primary_pharmacist.pharmacists.partials.table')
                                        </tbody>
                                    </table>
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    tabLinks.forEach(function(link) {
        link.addEventListener('click', function(e) {
            ...
            let url = "{{ route('primary_pharmacist.pharmacists.index') }}";
            if (role !== 'all') {
                url += '?role=' + role;
            }
