    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Add Payment
                <small class="text-muted">Create a new payment record</small>
                </h2>
            </div>
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Add</strong> New Payment</h2>
                    </div>
                    <div class="body">
                        @if($errors->any())
                        ...
                        <form method="POST" action="{{ route('nurse.payments.store') }}">
                            @csrf
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="amount" name="amount" class="form-control" step="0.01" min="0" value="{{ old('amount') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select id="method" name="method" class="form-control show-tick" required>
                                            ...
                                            <option value="cash_in_clinic" {{ old('method') == 'cash_in_clinic' ? 'selected' : '' }}>Cash</option>
                                            <option value="card_online" {{ old('method') == 'card_online' ? 'selected' : '' }}>Card (Paystack)</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select id="status" name="status" class="form-control show-tick" required>
                                            ...
                                            <option value="pending_cash_verification" {{ old('status') == 'pending_cash_verification' ? 'selected' : '' }}>Pending Cash Verification</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="transaction_date" name="transaction_date" class="form-control" value="{{ old('transaction_date', date('Y-m-d')) }}">
                                    </div>
                                </div>
                            </div>
