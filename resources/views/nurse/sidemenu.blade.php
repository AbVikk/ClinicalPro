    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/nurse/dashboard') }}"><img src="{{ asset('assets/images/logo.svg') }}" width="30" alt="ClinicalPro"><span class="m-l-10">ClinicalPro</span></a>
            </div>
        </li>
        <li><a href="javascript:void(0);" class="ls-toggle-btn" data-close="true"><i class="zmdi zmdi-swap"></i></a></li>
        <li class="d-none d-lg-inline-block"><a href="events.blade.php" title="Events"><i class="zmdi zmdi-calendar"></i></a></li>
...
<aside id="leftsidebar" class="sidebar">
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#user">Nurse</a></li>
    </ul>
            ...
            <div class="menu">
                <ul class="list">
                    <li>
                        <div class="user-info">
                            @if(Auth::user()->photo)
                                <div class="image"><a href="{{ route('nurse.dashboard') }}"><img src="{{ asset('storage/' . Auth::user()->photo) }}" alt="User"></a></div>
                            @else
                                <div class="image"><a href="{{ route('nurse.dashboard') }}"><img src="{{ asset('assets/images/profile_av.jpg') }}" alt="User"></a></div>
                            @endif
                            <div class="detail">
                                <h4>{{ Auth::user()->name ?? 'Nurse' }}</h4>
                                <small>Nurse</small>                        
                            </div>
                        </div>
                    </li>
                    <li class="header">MAIN</li>
                    <li><a href="{{ route('nurse.dashboard') }}"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>            
                    <li><a href="{{ url('/nurse/book-appointment') }}"><i class="zmdi zmdi-calendar-check"></i><span>Appointment</span> </a></li>
                    <li><a href="{{ route('nurse.patients.index') }}"><i class="zmdi zmdi-accounts"></i><span>Patients</span> </a></li>
                    <li><a href="javascript:void(0);"><i class="zmdi zmdi-hospital"></i><span>Vitals</span> </a></li>
                    <li><a href="javascript:void(0);"><i class="zmdi zmdi-file-text"></i><span>Reports</span></a></li>
    ...
    <div class="card">
        <div class="header">
            <ul class="list-unstyled team-info margin-0">
                <li class="m-r-15"><h2>Nurse Team</h2></li>
                <li>
                    <img src="../assets/images/xs/avatar2.jpg" alt="Avatar">
                </li>
                <li>
            ...
            <ul class="chat-scroll-list clearfix">
                <li class="left float-left">
                    ...
                    <div class="chat-info">
                        ...
                        <span class="message">Hello, Nurse </span>
                    </div>
                </li>
                <li class="right">
                ...
                <li class="left float-left"> <img src="{{ asset('assets/images/xs/avatar2.jpg') }}" class="rounded-circle" alt="">
                    <div class="chat-info"> <a class="name" href="#">Elizabeth</a> <span class="datetime">6:25</span> <span class="message">Hi, Alexander,<br> Nurse <br> What are you doing?</span> </div>
                </li>
