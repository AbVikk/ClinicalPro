...
<title>:: Oreo Hospital :: Search Result</title>
<!-- Favicon -->
                    ...
                    <div class="tab-pane" id="Oreo">
                        <div class="card">
                            <div class="body">
                                ...
                                <a href="javascript:void(0);">http://Oreo.com/lorem/timeline.blade.php</a>
                                <div class="row">
...
<script src="{{ asset('assets/plugins/light-gallery/js/lightgallery-all.min.js') }}"></script> <!-- RangeSlider Plugin Js -->
