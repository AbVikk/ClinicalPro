                        ...
                        <div class="row clearfix">
                                ...
                                <div class="card xl-blue member-card doctor">
                                    <div class="body">
                                        <div class="member-thumb">
                                            <img src="{{ asset('assets/images/doctors/member1.png') }}" class="img-fluid" alt="profile-image">                               
                                        </div>
                                        <div class="detail">
                                            ...
                                            <a href="profile.blade.php"  class="btn btn-default btn-round btn-simple">View Profile</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="card xl-khaki member-card doctor">
                                    <div class="body">
                                        <div class="member-thumb">
                                            <img src="{{ asset('assets/images/doctors/member2.png') }}" class="img-fluid" alt="profile-image">                               
                                        </div>
                                        <div class="detail">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="card xl-blue member-card doctor">
                                    <div class="body">
                                        <div class="member-thumb">
                                            <img src="{{ asset('assets/images/doctors/member3.png') }}" class="img-fluid" alt="profile-image">                               
                                        </div>
                                        <div class="detail">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="card xl-parpl member-card doctor">
                                    <div class="body">
                                        <div class="member-thumb">
                                            <img src="{{ asset('assets/images/doctors/member4.png') }}" class="img-fluid" alt="profile-image">                               
                                        </div>
                                        <div class="detail">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="card xl-pink member-card doctor">
                                    <div class="body">
                                        <div class="member-thumb">
                                            <img src="{{ asset('assets/images/doctors/member5.png') }}" class="img-fluid" alt="profile-image">                               
                                        </div>
                                        <div class="detail">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="card xl-seagreen member-card doctor">
                                    <div class="body">
                                        <div class="member-thumb">
                                            <img src="{{ asset('assets/images/doctors/member6.png') }}" class="img-fluid" alt="profile-image">                               
                                        </div>
                                        <div class="detail">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="card xl-blue member-card doctor">
                                    <div class="body">
                                        <div class="member-thumb">
                                            <img src="{{ asset('assets/images/doctors/member7.png') }}" class="img-fluid" alt="profile-image">                               
                                        </div>
                                        <div class="detail">
