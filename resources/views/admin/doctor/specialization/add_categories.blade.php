...
<title>:: Oreo Hospital :: Add Category</title>
<!-- Favicon -->
                    ...
                    <div class="body">
                        <form method="POST" action="{{ route('admin.categories.store') }}">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <textarea name="description" rows="4" class="form-control no-resize" placeholder="Category Description"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <button type="submit" class="btn btn-primary btn-round">Add Category</button>
                                    <a href="{{ route('admin.doctor.specialization.index') }}" class="btn btn-default btn-round btn-simple">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
