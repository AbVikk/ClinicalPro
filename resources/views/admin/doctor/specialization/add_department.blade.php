...
<title>ClinicalPro || Add Department</title>
<!-- Favicon -->
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Add</strong> New Department</h2>
                    </div>
                    <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control" placeholder="Department Name" value="{{ old('name') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <button type="submit" class="btn btn-primary btn-round">Add Department</button>
