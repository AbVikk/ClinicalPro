...
<title>ClinicalPro || Add Matron</title>
<!-- Favicon -->
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-7 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item active">Add Matron</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Add</strong> New Matron </h2>
                    </div>
                    <div class="body">
                        @if(session('success'))
                        ...
                        <form method="POST" action="{{ route('admin.matrons.store') }}">
                            @csrf
                            <div class="row clearfix">
                                <div class="col-sm-6">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <button type="submit" class="btn btn-primary btn-round">Add Matron</button>
