...
<title>:: Oreo Hospital :: Add Patient</title>
    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('admin.index') }}"><img src="{{ asset('assets/images/logo.svg') }}" width="30" alt="Oreo"><span class="m-l-10">Oreo</span></a>
            </div>
        </li>
        <li><a href="javascript:void(0);" class="ls-toggle-btn" data-close="true"><i class="zmdi zmdi-swap"></i></a></li>
        <li class="d-none d-lg-inline-block"><a href="{{ route('events.index') }}" title="Events"><i class="zmdi zmdi-calendar"></i></a></li>
        <li class="d-none d-lg-inline-block"><a href="{{ route('mail.inbox') }}" title="Inbox"><i class="zmdi zmdi-email"></i></a></li>
        <li><a href="{{ route('contact.index') }}" title="Contact List"><i class="zmdi zmdi-account-box-phone"></i></a></li>
        ...
        <div class="tab-pane stretchRight active" id="dashboard">
            <div class="menu">
                <ul class="list">
                    <li>
                        <div class="user-info">
                            <div class="image"><a href="{{ route('profile.index') }}"><img src="{{ asset('assets/images/profile_av.jpg') }}" alt="User"></a></div>
                            <div class="detail">
                                <h4>Dr. Charlotte</h4>
                    ...
                    <li><a href="{{ route('appointment.book') }}"><i class="zmdi zmdi-calendar-check"></i><span>Appointment</span> </a></li>
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-account-add"></i><span>Doctors</span> </a>
                        <ul class="ml-menu">
                            ...
                            <li><a href="{{ route('events.index') }}">Doctor Schedule</a></li>
                        </ul>
                    </li>
                    <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-account-o"></i><span>Patients</span> </a>
                        <ul class="ml-menu">
                            ...
                            <li class="active"><a href="{{ route('patients.create') }}">Add Patient</a></li>                       
                            <li><a href="{{ route('patient.show', 1) }}">Patient Profile</a></li>
                            <li><a href="{{ route('patient.invoice') }}">Invoice</a></li>
                        </ul>
                    </li>
                    ...
                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-lock"></i><span>Authentication</span> </a>
                        <ul class="ml-menu">
                            ...
                            <li><a href="{{ route('errors.404') }}">Page 404</a> </li>
                            <li><a href="{{ route('errors.500') }}">Page 500</a> </li>
                            <li><a href="{{ route('page.offline') }}">Page Offline</a> </li>
                            <li><a href="{{ route('locked') }}">Locked Screen</a> </li>
                        </ul>
                    </li>
                    <li class="header">EXTRA COMPONENTS</li>
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-blogger"></i><span>Blog</span></a>
                        <ul class="ml-menu">
                            <li><a href="{{ route('blog.dashboard') }}">Blog Dashboard</a></li>
                            <li><a href="{{ route('blog.post') }}">New Post</a></li>
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-folder"></i><span>File Manager</span> </a>
                        <ul class="ml-menu">
                            <li><a href="{{ route('file.dashboard') }}">All File</a></li>
                            <li><a href="{{ route('file.documents') }}" >Documents</a></li>
                            <li><a href="{{ route('file.media') }}" >Media</a></li>
                            <li><a href="{{ route('file.images') }}" >Images</a></li>
                        </ul>
                    </li>
                    ...
                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-delicious"></i><span>Widgets</span> </a>
                        <ul class="ml-menu">
                            <li><a href="{{ route('widgets.app') }}">Apps Widgetse</a></li>
                            <li><a href="{{ route('widgets.data') }}">Data Widgetse</a></li>
                        </ul>
                    </li>                    
                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-copy"></i><span>Sample Pages</span> </a>
                        <ul class="ml-menu">
                            ...
                            <li><a href="{{ asset('rtl/index.html') }}">RTL Support</a></li>
                    ...
                    <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-swap-alt"></i><span>User Interface (UI)</span> </a>
                        <ul class="ml-menu">
                            <li><a href="{{ route('ui.kit') }}">UI KIT</a></li>
                            <li><a href="{{ route('alerts.index') }}">Alerts</a></li>
                            <li><a href="{{ route('collapse.index') }}">Collapse</a></li>
                            <li><a href="{{ route('colors.index') }}">Colors</a></li>
                            <li><a href="{{ route('dialogs.index') }}">Dialogs</a></li>
                            <li><a href="{{ route('icons.index') }}">Icons</a></li>
                            <li><a href="{{ route('list.group') }}">List Group</a></li>
                            <li><a href="{{ route('media.object') }}">Media Object</a></li>
                            <li><a href="{{ route('modals.index') }}">Modals</a></li>
                            <li><a href="{{ route('notifications.index') }}">Notifications</a></li>                    
                            <li><a href="{{ route('progressbars.index') }}">Progress Bars</a></li>
                            <li><a href="{{ route('range.sliders') }}">Range Sliders</a></li>
                            <li><a href="{{ route('sortable.nestable') }}">Sortable & Nestable</a></li>
                            <li><a href="{{ route('tabs.index') }}">Tabs</a></li>
                            <li><a href="{{ route('waves.index') }}">Waves</a></li>
                        </ul>
                    </li>
