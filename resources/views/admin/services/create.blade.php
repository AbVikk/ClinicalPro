...
<title>Clinical Pro || Create Service</title>
<!-- Favicon -->
    ...
    <div class="container-fluid">        
        <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="card">
					<div class="header">
						<h2><strong>Create</strong> New Service</h2>
					...
					<div class="body">
                        ...
                        <form action="{{ route('admin.services.store') }}" method="POST">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="price_amount" name="price_amount" step="0.01" min="0.01" value="{{ old('price_amount') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control show-tick" id="default_duration" name="default_duration" required>
                                            <option value="30" {{ old('default_duration') == 30 ? 'selected' : '' }}>30 minutes</option>
                                            <option value="40" {{ old('default_duration') == 40 ? 'selected' : '' }}>40 minutes</option>
                                            <option value="60" {{ old('default_duration') == 60 ? 'selected' : '' }}>60 minutes</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="price_currency" name="price_currency" value="{{ old('price_currency', 'NGN') }}" maxlength="3" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    ...
                                    <div id="time-pricing-container">
                                        <!-- Time pricing rows will be added here dynamically -->
                                    </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <button type="submit" class="btn btn-primary btn-round">Create Service</button>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('add-time-pricing').addEventListener('click', function() {
            ...
            row.innerHTML = `
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label>&nbsp;</label><br>
                            <span class="remove-pricing" title="Remove">×</span>
                        </div>
                    </div>
                </div>
            `;
            ...
            // Initialize selectpicker for the new select element
