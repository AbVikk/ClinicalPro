    ...
    <div class="container">        
        ...
        <div class="navbar-collapse">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-white btn-round" href="sign-in.blade.php">SIGN IN</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="card-plain">
                <form class="form" method="" action="">
                    ...
                    <div class="footer text-center">
                        <a href="index.blade.php" class="btn btn-primary btn-round btn-block  waves-effect waves-light">SIGN UP</a>
                        <h5><a class="link" href="sign-in.blade.php">You already have a membership?</a></h5>
                    </div>
                </form>
            </div>
        </div>
